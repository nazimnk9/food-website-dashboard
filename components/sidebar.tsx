        ...
        >
          ...
          <div className="px-4 py-4 space-y-2 border-t border-gray-800">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:bg-red-600/10 hover:text-red-500 transition-all duration-200 ${isCollapsed && 'lg:justify-center'}`}
            >
